var albums = [
  Album('Nirvana',
      'https://images-na.ssl-images-amazon.com/images/I/715zRWC7sGL._AC_SL1500_.jpg'),
  Album('Queen',
      'https://images-na.ssl-images-amazon.com/images/I/71JuNbWD2bL._SL1400_.jpg'),
  Album('The Beatles',
      'https://los40es00.epimg.net/los40/imagenes/2018/09/26/los40classic/1537954405_106365_1569490515_noticia_normal.jpg'),
  Album('Metallica',
      'https://resources.claroshop.com/imagenes-sanborns-ii/1200/602498653258.jpg'),
  Album('The Ramones',
...
var podcasts = [
  ...
  // Album(
  // 'Firebase', 'https://www.codigors.com/images/logoLenguajes/firebase.jpg'),
  Album('Kotlin',
